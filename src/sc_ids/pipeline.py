...
Usage
-----
    # runnable now on built-in synthetic data (run from repo root):
    python -m sc_ids.pipeline

    # on the real GSE194315 data, which lives in this repo under data/
    # (kept local, gitignored). Run from the repo root:
    python -m sc_ids.pipeline \
...
from .batched import compute_IDS_blocked      # gene-blocked wrapper over ids.compute_IDS
from .streaming import compute_IDS_streaming  # cell-streaming + gene-blocking (out-of-core)
